...
enum WorldIntConfigs
{
    ...
    CONFIG_PVP_DROP_ID,
    CONFIG_GUILD_CHARTER_COST,
    CONFIG_ARENA_TEAM_CHARTER_2V2_COST,
    CONFIG_ARENA_TEAM_CHARTER_3V3_COST,
    CONFIG_ARENA_TEAM_CHARTER_5V5_COST,
